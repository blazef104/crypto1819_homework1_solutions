...
\begin{itemize}
    ...
    \todo{
    \item the couple $(m_{j}, \phi_{j})$ for which $b$ is equal to 1, if
            used as challenge couple, \textbf{wins} the game for sure: in other
            words, the oracle \textit{predicts the result of a potential
            execution of Tag function with that couple}
        }
